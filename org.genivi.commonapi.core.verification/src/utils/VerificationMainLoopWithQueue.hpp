// Copyright (C) 2013-2019 Bayerische Motoren Werke Aktiengesellschaft (BMW AG)
// This Source Code Form is subject to the terms of the Mozilla Public
// License, v. 2.0. If a copy of the MPL was not distributed with this
// file, You can obtain one at http://mozilla.org/MPL/2.0/.

#ifndef VERIFICATION_MAIN_LOOP_WITH_QUEUE_HPP_
#define VERIFICATION_MAIN_LOOP_WITH_QUEUE_HPP_
...
#endif /* VERIFICATION_MAIN_LOOP_WITH_QUEUE_HPP_ */
