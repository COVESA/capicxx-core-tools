...
#ifndef DTPRIMITIVESTUB_HPP_
#define DTPRIMITIVESTUB_HPP_
...
public:
    ...
    virtual void fTest(const std::shared_ptr<CommonAPI::ClientId> _client,
                       uint8_t _uint8In, int8_t _int8In,
                       uint16_t _uint16In, int16_t _int16In,
                       uint32_t _uint32In, int32_t _int32In,
                       uint64_t _uint64In, int64_t _int64In,
                       bool _booleanIn, 
                       float _floatIn, const double _doubleIn,
                       std::string _stringIn,
                       CommonAPI::ByteBuffer _byteBufferIn,
                       CommonAPI::RangedInteger<5,15> _integerIn,
                       fTestReply_t _reply);
    virtual void fTestEmptyBroadcast(const std::shared_ptr<CommonAPI::ClientId> _client,
